...
export default function PortalHubPage() {
  return (
    <div className="min-h-[calc(100vh-100px)] bg-steel-50 text-steel-900 dark:bg-steel-950 dark:text-steel-100 flex items-center justify-center font-sans">
      <div className="w-full max-w-4xl px-6 py-4 animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <Link
            href="/portal/quote"
            className="group relative bg-white/60 dark:bg-steel-900/40 backdrop-blur-xl border border-steel-200/60 dark:border-steel-800/60 p-6 rounded-3xl shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 text-left overflow-hidden block"
          >
            ...
            <div className="relative z-10 flex flex-col h-full">
              <div className="w-10 h-10 bg-brand-50 dark:bg-brand-950 text-brand-600 dark:text-brand-400 rounded-2xl flex items-center justify-center mb-3 group-hover:scale-110 transition-transform">
              ...
              <div className="mt-4 flex items-center gap-2 font-medium opacity-0 group-hover:opacity-100 transition-opacity -translate-x-4 group-hover:translate-x-0 duration-300 text-brand-600 dark:text-brand-400">
          ...
          >
            ...
            <div className="relative z-10 flex flex-col h-full">
              <div className="w-10 h-10 bg-indigo-50 dark:bg-indigo-950 text-indigo-600 dark:text-indigo-400 rounded-2xl flex items-center justify-center mb-3 group-hover:scale-110 transition-transform">
              ...
              <div className="mt-4 flex items-center gap-2 font-medium opacity-0 group-hover:opacity-100 transition-opacity -translate-x-4 group-hover:translate-x-0 duration-300 text-indigo-600 dark:text-indigo-400">
                Devam Et <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg>
              </div>
            </div>
          </Link>
          ...
          >
            ...
            <div className="relative z-10 flex flex-col h-full">
              <div className="w-10 h-10 bg-orange-50 dark:bg-orange-950 text-orange-500 dark:text-orange-400 rounded-2xl flex items-center justify-center mb-3 group-hover:scale-110 transition-transform">
              ...
              <div className="mt-4 flex items-center gap-2 font-medium opacity-0 group-hover:opacity-100 transition-opacity -translate-x-4 group-hover:translate-x-0 duration-300 text-orange-500 dark:text-orange-400">
                Devam Et <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg>
              </div>
            </div>
          </Link>
          ...
          >
            ...
            <div className="relative z-10 flex flex-col h-full">
              <div className="w-10 h-10 bg-emerald-50 dark:bg-emerald-950 text-emerald-600 dark:text-emerald-400 rounded-2xl flex items-center justify-center mb-3 group-hover:scale-110 transition-transform">
              ...
              <div className="mt-4 flex items-center gap-2 font-medium opacity-0 group-hover:opacity-100 transition-opacity -translate-x-4 group-hover:translate-x-0 duration-300 text-emerald-600 dark:text-emerald-400">
                Devam Et <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg>
              </div>
            </div>
          </a>
