...
export const STORY_CHAPTERS: readonly StoryChapterData[] = [
  ...
  },
  {
    ...
    body: "70 HRc sertliğinde işlenmiş iç yüzeyler ve kendi kendini temizleyen kademeli filtreler; bakım aralığını yıllara, gövde ömrünü on yıllara taşır.",
    metric: { value: "70 HRc", label: "işlenmiş iç yüzey sertliği" },
    align: "right",
    tone: "dark",
